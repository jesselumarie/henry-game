...
export const DEFAULT_SKI_LEVEL = {
  ...
  width: 3200,
  height: 600,
  // Object y values are lane offsets from the slope surface:
  // negative = uphill side, positive = downhill side, 0 = center
  objects: [
    { type: 'obstacle_tree', x: 400, y: 0 },
    { type: 'obstacle_tree', x: 600, y: -80 },
    { type: 'obstacle_rock', x: 900, y: 60 },
    { type: 'collectible_coin', x: 500, y: -30 },
    { type: 'collectible_coin', x: 700, y: 40 },
    { type: 'collectible_star', x: 850, y: -50 },
    { type: 'ramp', x: 1200, y: 0 },
    { type: 'collectible_potion', x: 1400, y: -60 },
    { type: 'obstacle_tree', x: 1500, y: -80 },
    { type: 'obstacle_rock', x: 1800, y: 50 },
    { type: 'collectible_coin', x: 1600, y: 0 },
    { type: 'collectible_coin', x: 2000, y: -70 },
    { type: 'ramp', x: 2200, y: 0 },
    { type: 'collectible_potion', x: 2400, y: 30 },
    { type: 'obstacle_tree', x: 2500, y: -30 },
    { type: 'collectible_star', x: 2700, y: 10 },
    { type: 'obstacle_rock', x: 2900, y: 80 },
  ],
};
